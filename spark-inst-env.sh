...
sudo mv /opt/spark-${SPARK_VER}-bin-without-hadoop /opt/spark-${SPARK_VER}
sudo ln -sf /opt/spark-${SPARK_VER} /opt/spark
sudo chown spark:hadoop /opt/spark
sudo chown -R spark:hadoop /opt/spark-${SPARK_VER}
#
